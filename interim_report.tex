...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Model Architecture for Bidirectional GRU Aligner for source $s$, target $t$ alignments. $\alpha$ is a global learnable scaling factor for the importance of alignment distribution $\log \sigma_t(a)$, and $\lambda$ is the global alignment distortion parameter.}

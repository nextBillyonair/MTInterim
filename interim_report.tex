...
The following results %(see Tables \ref{fig:prelim-results-dot},
%\ref{fig:prelim-results-gru})
are from the preliminary version of our model and
...
% For the final report, we intend to incorporate batching
